...
Bankstack is maintained by [Automata Partners](https://www.automatapartners.com/). Start with the [public docs](https://bankstack.dev/docs/), [VISION.md](VISION.md) for the product direction, [packages/create-bankstack](packages/create-bankstack) for the published CLI, and [apps/docs](apps/docs) for the docs site source.
